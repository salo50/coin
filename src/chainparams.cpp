...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("80.240.17.77","80.240.17.77"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("45.76.151.173","45.76.151.173"));    // Secondary DNS Seeder from Fuzzbawls
